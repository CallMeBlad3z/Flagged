...
const TermsOfService = ({ onAccept, onRefuse, showButtons = true, onClose }: { onAccept?: () => void, onRefuse?: () => void, showButtons?: boolean, onClose?: () => void }) => {
  ...
  // Local terms of service content
  const terms = `
    <html>
      <head>
        <style>
          ...
          @font-face {
            ...
            src: url('file:///android_asset/fonts/SourceSans3-Regular.ttf'); /* For Android */
          }
          body {
            font-size: 32px;
            margin: 24px;
      ...
      <body>
        ...
        <ul>
          <li>
            <p><strong>Application</strong> means the software program provided by the Company downloaded by You on any electronic device, named Flagged.</p>
          </li>
          <li>
          ...
          <li>
            <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Flagged..</p>
          </li>
          <li>
        ...
        <ul>
          <li>By email: info@flagged-app.com</li>
        </ul>
      </body>
    </html>
  `;
